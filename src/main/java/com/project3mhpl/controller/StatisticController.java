...
public class StatisticController {
    ...
    @GetMapping("/filter")
    public String filter(@RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate, @RequestParam("khoa") String khoa, @RequestParam("nganh") String nganh, Model m, HttpServletRequest request) throws ParseException {
        Boolean isAuthenticated = thanhVienService.checkAuth(request);
        Boolean isAdmin = thanhVienService.checkAdmin(request);
    ...
    public String filterBorrow(@RequestParam("startDateBorrow") String startDate, @RequestParam("endDateBorrow") String endDate, @RequestParam("devices") String device, Model m, HttpServletRequest request) throws ParseException {
        Boolean isAuthenticated = thanhVienService.checkAuth(request);
        Boolean isAdmin = thanhVienService.checkAdmin(request);
    ...
    public String filterBorrowing(@RequestParam("startDateBorrowing") String startDate, @RequestParam("endDateBorrowing") String endDate, Model m, HttpServletRequest request) throws ParseException {
        Boolean isAuthenticated = thanhVienService.checkAuth(request);
        Boolean isAdmin = thanhVienService.checkAdmin(request);
